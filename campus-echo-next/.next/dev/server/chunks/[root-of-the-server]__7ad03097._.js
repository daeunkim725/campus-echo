...
"[project]/campus-echo-next/app/api/auth/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/campus-echo-next/lib/auth.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/campus-echo-next/lib/rateLimit.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$app$2f$api$2f$auth$2f$signup$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/campus-echo-next/app/api/auth/signup/route.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request) {
    const ip = request.headers.get("x-forwarded-for") ?? "unknown";
    const limited = (0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkRateLimit"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$rateLimit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rateLimitKey"])("login", ip), 10, 15 * 60 * 1000);
    if (limited) return limited;
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["compareSync"])(password, user.password_hash)) {
            return Response.json({
                error: "Invalid email or password"
            }, {
                status: 401
        ...
        if (!user.anon_id) {
            updates.anon_id = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAnonId"])(user.email);
        }
        const finalUser = Object.keys(updates).length > 0 ? await __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.update({
            where: {
                id: user.id
            },
            data: updates
        }) : user;
        const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createJWT"])(finalUser.id, finalUser.email, finalUser.school_id, 24);
        const response = Response.json({
            token,
            user: (0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$app$2f$api$2f$auth$2f$signup$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["safeUser"])(finalUser)
        });
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$campus$2d$echo$2d$next$2f$app$2f$api$2f$auth$2f$signup$2f$route$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["setTokenCookie"])(response, token);
        return response;
    } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7ad03097._.js.map