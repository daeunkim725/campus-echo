            ...
            <button
              ...
              style={{ backgroundColor: school.color }}>
                    ...
                    <div className="flex justify-center mt-5">
                        <Link
              to="/login" className="bg-slate-500 text-[13px] px-4 py-1 font-semibold rounded-xl hover:bg-slate-600 active:bg-slate-700 transition-all shadow-sm">or Log in
