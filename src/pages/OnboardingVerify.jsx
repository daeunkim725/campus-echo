...
export default function OnboardingVerify() {
    ...
    const handleVerifyCode = async () => {
        ...
        try {
            ...
            navigate("/OnboardingPassword", { replace: true });
        } catch (err) {
        ...
        <div className="min-h-screen bg-[#F6F8FC] flex flex-col">
            ...
            <div className="flex-1 flex items-start justify-center px-4 pt-4 pb-12">
                <div className="w-full max-w-sm">
                    ...
                    {step === "email" ? (
                        <>
                            <button onClick={() => navigate("/OnboardingSchool", { replace: true })}
                                ...
                                <div className="flex justify-center w-full mb-3">
                                    ...
                                    >
                                        <InputOTPGroup>
                                            ...
                                            <InputOTPSlot index={1} className="w-10 h-12 text-lg font-bold border-slate-300" />
                                            <InputOTPSlot index={2} className="w-10 h-12 text-lg font-bold border-slate-300" />
                                            <InputOTPSlot index={3} className="w-10 h-12 text-lg font-bold border-slate-300" />
                                            <InputOTPSlot index={4} className="w-10 h-12 text-lg font-bold border-slate-300" />
                                            <InputOTPSlot index={5} className="w-10 h-12 text-lg font-bold border-slate-300" />
                                        </InputOTPGroup>
                                    </InputOTP>
                                </div>
